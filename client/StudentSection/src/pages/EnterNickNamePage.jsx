...
const EnterNickNamePage = () => {
    ...
    const [loadingText, setLoadingText] = useState("please, Wait a little Bit, connecting...")
                ...
                <div className='w-1/3 flex flex-col items-center justify-center p-4'>
                    ...
                    <div className='w-72 h-36 bg-white rounded-md p-3 flex flex-col items-center justify-center'>
                        <input
                            ...
                            className='w-full h-12 text-center font-bold rounded-md text-[#2f2f2f] border-2 border-gray-500 outline-none focus:border-black' type="text" placeholder='Enter NickName' />
                        <button 
